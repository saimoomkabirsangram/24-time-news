            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="staticBackdropLabel">${catDetails.title ? catDetails.title: 'Not Found'}</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                <span>${catDetails.author.name? catDetails.author.name: 'No author'}</span>
                <span>View:${catDetails.total_view? catDetails.total_view:'Still no view'}</span>
                </div>
                <div class="modal-footer">
                  <img src="${catDetails.author.img ? catDetails.author.img: 'Not Found'}" class="card-img-bottom img-thumbnail rounded-4" alt="...">
